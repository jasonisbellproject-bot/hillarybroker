...
async function fixReferralRewardsSimple() {
  console.log('🔧 Fixing Referral Rewards (Simple Approach)...\n');
  ...
  try {
    ...
    for (const referral of referrals || []) {
      ...
      if (undefinedReward) {
        ...
        // Create new reward (without source field for now)
